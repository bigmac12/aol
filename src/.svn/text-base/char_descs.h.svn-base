...
#define NUM_FEATURE_TYPES 8

#define NUM_EYE_DESCRIPTORS            22
#define NUM_NOSE_DESCRIPTORS           12
#define NUM_EAR_DESCRIPTORS            10
#define NUM_FACE_DESCRIPTORS           18
#define NUM_SCAR_DESCRIPTORS           23
#define NUM_HAIR_DESCRIPTORS           37
#define NUM_BUILD_DESCRIPTORS          17
#define NUM_COMPLEXION_DESCRIPTORS     13
