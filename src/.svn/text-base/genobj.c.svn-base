...
int save_objects(zone_rnum zone_num)
{
  ...
  char ebuf1[MAX_STRING_LENGTH];
  char ebuf2[MAX_STRING_LENGTH];
  char ebuf3[MAX_STRING_LENGTH];
  char ebuf4[MAX_STRING_LENGTH];
  char wbuf1[MAX_STRING_LENGTH];
  char wbuf2[MAX_STRING_LENGTH];
  char wbuf3[MAX_STRING_LENGTH];
  char wbuf4[MAX_STRING_LENGTH];
  char pbuf1[MAX_STRING_LENGTH];
  char pbuf2[MAX_STRING_LENGTH];
  char pbuf3[MAX_STRING_LENGTH];
  char pbuf4[MAX_STRING_LENGTH];
...
void copy_object_strings(struct obj_data *to, struct obj_data *from)
{
  ...
  if (SCRIPT(from))
    script_copy(to, from, OBJ_TRIGGER);
}
