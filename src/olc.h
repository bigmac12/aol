...
#define REDIT_PULSE_MESG                17
#define REDIT_PULSE_DAM                 18
#define REDIT_SPECS                     19
...
/*  PDH  2/22/99  */
#define ZEDIT_ZONE_OWNER		14
#define ZEDIT_ZONE_STATUS		15
#define ZEDIT_ZONE_LEVELS		16
...
#define MEDIT_SPELL_FLAGS		8
#define MEDIT_SPELL_CASTPCT		9
#define MEDIT_CONFIRM_DEFAULT           10
/*  I'm cheating, but it only calls numerical_response to check if
    you're greater than it or not - since it's not an actual state, it's
    not going to conflict with the confirm.  Whoever set up this struct
    without an enum needs to be shot, though.  Soli, 7/99  */
/*  Unfortunately, I need new ones now anyway, so let's jack it all up by 10 */
#define MEDIT_CLASS                     11
#define MEDIT_SPEC                      12
#define MEDIT_NUMERICAL_RESPONSE        20
#define MEDIT_SEX			21
#define MEDIT_HITROLL			22
#define MEDIT_DAMROLL			23
#define MEDIT_MAXMOVE                   24
#define MEDIT_NDD			25
#define MEDIT_SDD			26
#define MEDIT_NUM_HP_DICE		27
#define MEDIT_SIZE_HP_DICE		28
#define MEDIT_ADD_HP			29
#define MEDIT_AC			30
#define MEDIT_EXP			31
#define MEDIT_GOLD			32
#define MEDIT_POS			33
#define MEDIT_DEFAULT_POS		34
#define MEDIT_ATTACK			35
#define MEDIT_LEVEL			36
#define MEDIT_ALIGNMENT			37
#define MEDIT_NUM_ATTACK		38
#define MEDIT_MOB_PROG                  39
#define MEDIT_SKIN_DATA0                40
#define MEDIT_SKIN_DATA1                41
#define MEDIT_SKIN_DATA2                42
#define MEDIT_SKIN_DATA3                43
#if defined(OASIS_MPROG)
#define MEDIT_MPROG                     44
#define MEDIT_CHANGE_MPROG              45
#define MEDIT_MPROG_COMLIST             46
#define MEDIT_MPROG_ARGS                47
#define MEDIT_MPROG_TYPE                48
#define MEDIT_PURGE_MPROG               49
#endif
...
#define SEDIT_MIN_OBJ_LEVEL             37
#define SEDIT_MAX_OBJ_LEVEL             38
/*
 * Limit information.
 */
...
#define MAX_EXTRA_DESC  900
#define MAX_MOB_DESC	900
#define MAX_OBJ_DESC	900
#define NUM_OLC_SPEC    11
#define NUM_ROOM_SPECS  2
