...
#define ZONE_WORK     1
#define ZONE_REVIEW   2
#define ZONE_CLOSED   3
#define ZONE_OPEN     4
#define ZONE_EMPTY    5
...
struct zone_data {
  ...
  /*  PDH  2/22/99
   *
   *  zone_status is:  work, review, closed, open    default: work
   *  owner       is:  owner's name                  default: noone
   *  zone_levels is:  list of 15 levels (0 or 1)    default: all 0's
   *
   *  saved in *.zon as "* ZoneState work Owner 001111111000000"  (etc.)
   *  just after  "<top> <lifespan> <reset>"
   */
  int   zone_status;
