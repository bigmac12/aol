...
void init_spell_levels(void)
{
  ...
  spell_level(SKILL_SECOND_ATTACK, CLASS_KNIGHT, 20, 0);
  ...
  spell_level(SKILL_THIRD_ATTACK, CLASS_PALADIN, 25, 0);
 ...
 //  spell_level(SKILL_SCRIBE, CLASS_CLERIC, 13, 0);
  ...
  spell_level(SKILL_DUAL_WIELD, CLASS_RANGER, 6, 0);
...
//spell_level(SKILL_BASH, CLASS_RANGER, 9, 0);
  ...
  spell_level(SKILL_THIRD_ATTACK, CLASS_RANGER, 23, 0);
...
//spell_level(SPELL_WATER_WALK, CLASS_RANGER, 23, SPHERE_CLE_ELEMENTAL);
  ...
  spell_level(SKILL_SECOND_ATTACK, CLASS_ROGUE, 15, 0);

  spell_level(SKILL_DIRTKICK, CLASS_ROGUE, 16, 0);
  spell_level(SKILL_ENVENOM, CLASS_ROGUE, 18, 0);
  spell_level(SKILL_DUAL_WIELD, CLASS_ROGUE, 20, 0);
  ...
  spell_level(SKILL_DUAL_WIELD, CLASS_WARRIOR, 15, 0);
  ...
  spell_level(SKILL_THIRD_ATTACK, CLASS_WARRIOR, 25, 0);
  ...
  spell_level(SKILL_SECOND_ATTACK, CLASS_MONK, 9, 0);
  spell_level(SKILL_CHAKRA, CLASS_MONK, 10, 0);
  ...
  spell_level(SKILL_THIRD_ATTACK, CLASS_MONK, 17, 0);
  ...
  spell_level(SKILL_FOURTH_ATTACK, CLASS_MONK, 26, 0);
  ...
  spell_level(SKILL_SECOND_ATTACK, CLASS_DEFENDER, 17, 0);
  ...
  spell_level(SKILL_ENCHANT_ITEM, CLASS_DRUID, 6, 0);
