	...
	*d->str = NULL;
	...
	SEND_TO_Q("Mail aborted.\r\n", d);
      ...
      Board_save_board(d->mail_to - BOARD_MAGIC);
        ...
        if (!d->str) {
        *d->str = str_dup("Looks like someone forgot what they were going to write.\r\n");
      }
   }
    ...
    } else if (STATE(d) == CON_QLONG_D) {
      SEND_TO_Q("Enter your short description, something like:\r\n", d);
      SEND_TO_Q("a fat, balding man with shifty eyes\r\n--> ", d);
      STATE(d) = CON_QSHORT_D;
