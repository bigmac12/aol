...
sits~
   ...
   wait 3s
   say My only guess is that my strength comes from the waters of &RTaragral Springs&C.&n
   wait 5s
   say I returned from my stay there to find them all so sick.  I began to feel weak shortly thereafter.
   wait 6s
   headrub me
   wait 2s
   say Now I am too weak to make it back to find the Springs myself.
   wait 3s
   say Could you find the springs for me and bring back some of the water? Would you?
   wait 1s
   emo watches you, eagerly waiting for you to &Rnod&n or &Rshake&n your head.
~
#8194
m8193 Reward Trigger~
0 j 100
None~
if (%object.vnum% == 11411) then
set num %random.10%
   wait 2
   emote turns to you, her face brightening up.
   wait 1s
   say Thank you, with each of these vials you bring me you save another life.
   wait 2s
   mpurge taragral
   emote reaches into her pockets, searching for a reward to give you.
   wait 2s
   if (%num% <= 9)
      mload obj 8195
      give coins %actor.alias%
   elseif (%num% == 10)
      say I have just the thing.
      wait 1s
      say This has always brought me good luck, maybe it can do the same for you.
      mload obj 8160
      give amethyst %actor.alias%
   end
end
~
#8195
...
~
   wait 2
   say Please, listen to me, the lives of many people depend on it!
   wait 2s
   say I am in need of a large amount of &RTaragral Spring water&C.&n
   wait 4s
   say I can reward you for every vial of it you bring.  Please, &Rsit&C down if you'd like to hear more information.&n
~
#8196
m8193 nod~
0 e 1
nods~
   ...
   wait 3s
   say I do not know where the spring itself is exactly.  I've heard rumors of it being in Solamnia somewhere.  Near a fortress I think.
~
#8197
m8193 shake~
0 e 1
shakes~
   wait 2
   emote turns her face away from you.
   wait 2s
...
give 1c %actor.alias%
   wait 1s
   say That is all I have to offer. I hope it is enough.
   wait 1s
   say I will also remember you in my prayers each day.
else
   wait 1s
   say Sorry, but I am not sure that this will help.
   wait 1s
   give %object.alias% %actor.alias%
   wait 1s
   say I appreciate your time, though.
end
~
$~
