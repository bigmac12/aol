...
wait 3s
wsend %actor% Sensing there may be something more than meets the eye, you pick up one of the nearby shovels and start to dig through the soft soil.
...
if ("%arg" == "tombstone") 
wsend %actor% Ok.
wechoaround %actor% %actor.name% opens the tombstone.
wdoor 6471 up flags a
end
end
~
#6413
